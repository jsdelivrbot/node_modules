...
var UIButton = exports.UIButton = function (_React$Component) {
  ...
  UIButton.prototype.render = function render() {
    ...
    var props = (0, _puiReactHelpers.mergeProps)(others, buttonClasses);
    ...
    if (buttonText && !iconOnly) {
      props = (0, _puiReactHelpers.mergeProps)(props, { 'aria-label': buttonText });
    ...
    return this.props.href ? _react2.default.createElement(
      ...
      'button',
      (0, _puiReactHelpers.mergeProps)(props, { type: 'button' }),
      buttonContent
    );
  };
