...
var Input = exports.Input = function (_React$Component) {
  ...
  Input.prototype.render = function render() {
    ...
    var inputProps = (0, _helpers.mergeProps)(props, { className: inputClassNames, 'aria-label': placeholder });
    var leftIconSrc = leftIcon || search && 'search';
    var customLeftIcon = typeof leftIconSrc === 'string' ? _react2.default.createElement(_iconography.Icon, { className: 'input-icon', src: leftIconSrc }) : _react2.default.createElement(
      'span',
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        success && _react2.default.createElement(_iconography.Icon, { className: 'success', src: 'check' })
      ),
